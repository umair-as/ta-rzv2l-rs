...
extern "C" {
    ...
    pub fn _utee_log(buf: *const c_void, len: usize);
    ...
    pub fn _utee_check_access_rights(flags: u32, buf: *const c_void, len: usize)
        -> TEE_Result;
    ...
    pub fn _utee_hash_init(state: c_ulong, iv: *const c_void, iv_len: usize) -> TEE_Result;
    pub fn _utee_hash_update(state: c_ulong, chunk: *const c_void, chunk_size: usize)
        -> TEE_Result;
    ...
    pub fn _utee_cipher_init(state: c_ulong, iv: *const c_void, iv_len: usize) -> TEE_Result;
    ...
    pub fn _utee_cryp_random_number_generate(buf: *mut c_void, blen: usize) -> TEE_Result;
    ...
    pub fn _utee_storage_obj_write(obj: c_ulong, data: *const c_void, len: usize) -> TEE_Result;
    pub fn _utee_storage_obj_trunc(obj: c_ulong, len: usize) -> TEE_Result;
    pub fn _utee_storage_obj_seek(obj: c_ulong, offset: i32, whence: c_ulong) -> TEE_Result;
    pub fn _utee_cache_operation(va: *mut c_void, l: usize, op: c_ulong) -> TEE_Result;
// unimplemented syscall
// pub fn utee_gprof_send(buf: *mut c_void, size: usize, id: *mut u32) -> TEE_Result;
}
